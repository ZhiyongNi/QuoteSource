...
public class CommWriteFile {
	...
	public CommWriteFile(String filepath)throws Exception{
	...
	public void makeFile()throws Exception{
		try{
			...
			this.file=new File(filepath+currentDate+"-"+(MarketPriceServer.serverCode)+".txt");
			if(!file.exists()){
				file.createNewFile();
				if(this.write!=null){
					this.write.close();
